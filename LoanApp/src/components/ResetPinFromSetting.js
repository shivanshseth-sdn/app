...
class ResetPinFromSetting extends Component{
...
const mapStateToProps = ({ resetAccessPinReducer }) => {
  ...
  console.log("ResetPinFromSetting pin Output: "+JSON.stringify(resetPinRes));
...
export default connect(mapStateToProps,{oldPinChanged,pinChangedReset,confirmPinChangedReset,showLoadingResetPin,clearResponseResetPin,ResetPinReq})(ResetPinFromSetting);
